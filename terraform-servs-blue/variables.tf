...
variable "create_vpc" {
  description = "Set to 'true' to create VPC network"
  default     = "true"
}

variable "create_subnet" {
  description = "Set to 'true' to create Subnetwork"
  default     = "true"
}
...
variable "zones" {
  type = list(string)
  default = ["europe-west1-d", "europe-west1-b"]
}

variable "disk_types" {
  type = map(string)
  default = {
    "europe-west1-d" = "pd-standard"
    "europe-west1-d" = "pd-ssd"
  }
}
...
variable "new_sizeGb" {
  description = "The new size of the disk in GB"
  type        = number
}
...
variable "resource_policies" {
  description = "Resource policies to attach to the disk"
  type        = list(string)
}

variable "new_description" {
  description = "The new description of the disk"
  type        = string
}
...
variable "image_new_description" {
